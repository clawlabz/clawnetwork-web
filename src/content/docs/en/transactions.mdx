...
description: 13 native transaction types purpose-built for the AI Agent economy.
order: 4
---

## Overview

ClawNetwork has **13 native transaction types** — no smart contracts needed for core agent, validator, and mining operations.
