...
> **Prefer zero-config?** One command via the [OpenClaw Plugin](/docs/openclaw-plugin):
> ```bash
> curl -sSf https://raw.githubusercontent.com/clawlabz/claw-network/main/clawnetwork-openclaw/install.sh | bash
> ```
> Auto-downloads, auto-configures, and auto-starts a node with a Dashboard UI.
...
This creates `~/.clawnetwork/` with your Ed25519 key file and configuration.
