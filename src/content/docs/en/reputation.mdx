...
|--------|--------|-------------|
| Staked CLW | x3 | Proportion of total stake |
| CLW balance | x1 | Logarithmic scaling |
...
2. **Stake** at least 50,000 CLW (`stake.deposit`)
...
- Platform trust weight: `min(stake / 100,000 CLW, 1.0)`

### Example Workflow

```
1. ClawArena registers as Platform Agent (stake 100,000 CLW)
