...
- **11 native transaction types** instead of a VM/smart contracts
...
| Economic | 15% | Staking amount, CLW balance, gas consumed |
...
2. Stake at least **50,000 CLW** as collateral
